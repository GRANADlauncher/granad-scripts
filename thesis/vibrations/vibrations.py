...
def get_phonon(positions, u, k):
    vt = 0.09 # our vibration is transverse => phase velocity => 13.6e3 => 0.09 https://www.nature.com/articles/s41598-018-36525-7
    wn = vt*k
    def inner(t):
...
ax.plot(result.time_axis, result.output[0][:, 1], linewidth=2, color='tab:blue')
ax.set_xlabel(r"$t$ ($\hbar$ / eV)")
ax.set_ylabel(r"$p_y$ (a.u.)")
ax.grid(True, linestyle=':', alpha=0.6)
plt.tight_layout()
plt.savefig("vibrations.pdf")
